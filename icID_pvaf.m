...
chaninds=chans;
if length(chaninds)>length(ALLEEG(sets(1)).icachansind);
    chaninds=ALLEEG(sets(1)).icachansind;
end
%if isempty(chans);
...
%.........................................................................
%Start... Convert data to spectra for spectral classification...
%.........................................................................

%ADD FFT OR PWELCH TRANFORMATION TO EACH TRIAL AND CHANNEL/COMPONENT OF EEG.data and EEG.icaact

%.........................................................................
%End... Convert data to spectra for spectral classification...
%.........................................................................
...
%.........................................................................
if length(sets)==1;
    data = mean(ALLEEG(sets).data(ALLEEG(sets).icachansind,:,:),3);
    for ici=1:length(comps);
        proj_uniq(:,:,ici)=ALLEEG(sets).icawinv(:,comps(ici))* ...
                        mean(ALLEEG(sets).icaact(comps(ici),:,:),3);
    end
elseif length(sets)==2;
    data=mean(ALLEEG(sets(1)).data(ALLEEG(sets).icachansind,:,:),3)-mean(ALLEEG(sets(2)).data(:,:,:),3);
    for ici=1:length(comps);
...
data_tv=var(data(:,ERPpnts),[],2);
proj_tv_iniq=var(proj_uniq(:,ERPpnts,:),[],2);
for ici=1:length(comps);
    proj_tvr_uniq(:,1,ici)=var((data(:,ERPpnts)-proj_uniq(:,ERPpnts,ici)),[],2);
...
for ici=1:length(comps);
    ...
    proj_tvr_cum(:,1,ici)=var((data(:,ERPpnts)-proj_cum(:,ERPpnts,ici)),[],2);
